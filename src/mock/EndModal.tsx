...
const EndModal = ({ modalVisible, setModalVisible, confirmEnd }: MyProps) => {
	return (
		<Modal
			animationType="slide"
			transparent={true}
			...
			<View style={styles.centeredView}>
				<View style={styles.modalView}>
					<View style={styles.displayFlex}>
						<Text style={styles.bold}>Confirm End Test</Text>
						<TouchableOpacity
					...
					>
						<Text style={styles.txt}>Are you sure want to end the test?</Text>
					</View>
					<View style={styles.displayFlex}>
						<TouchableOpacity
							onPress={() => setModalVisible(false)}
